    ...
    <section class="latest spad" style="margin-top:150px">
        ...
        <section class="di-hero-section">
            <div class="di-card-grid">
                <a class="di-card" href="#">
                    <div class="di-card__background"
                    ...
                    <div class="di-card__content">
                        <p class="di-card__category">Category</p>
                        <h3 class="di-card__heading">Example di-card Heading</h3>
                    </div>
                </a>
                <a class="di-card" href="#">
                    <div class="di-card__background"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button style="background-color: #e0084e; border-color: #e0084e; color: white; width: 50%;"
                                class="btn btn-light" type="button" data-bs-dismiss="modal">Close
                            </button>
                        </div>
                    </div>
                </div>
