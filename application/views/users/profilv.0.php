                                                ...
                                                <div class="timeline-panel">
                                                    <div class="media mr-2">
                                                        <img alt="image" width="50"
                                                            src="<?=$url?>public/images/avatar/1.jpg">
                                                    </div>
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
                ...
                <div class="copyright">
                    <p class="fs-14 font-w200"><strong class="font-w400">Karciz Ticketing Admin Dashboard</strong> ©
                            ...
                            <div class="profile-head">
                                ...
                                <div class="profile-info">
                                    <div class="profile-photo">
                                        <img src="<?=$url?>public/images/profile/profile.png"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="profile-blog mb-5">
                                    ...
                                    <img src="<?=$url?>public/images/profile/1.jpg" alt=""
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                            <a href="javascript:void()" class="interest-cat">
                                                <img src="<?=$url?>public/images/profile/2.jpg" alt=""
                                                    class="img-fluid">
                                                <p>Shopping Mall</p>
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                            <a href="javascript:void()" class="interest-cat">
                                                <img src="<?=$url?>public/images/profile/3.jpg" alt=""
                                                    class="img-fluid">
                                                <p>Photography</p>
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                            <a href="javascript:void()" class="interest-cat">
                                                <img src="<?=$url?>public/images/profile/4.jpg" alt=""
                                                    class="img-fluid">
                                                <p>Art &amp; Gallery</p>
                                            </a>
                                        </div>
                                ...
                                <div class="profile-news">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="<?=$url?>public/images/profile/5.jpg" alt="image" class="mr-3 rounded"
                                            width="75">
                                        <div class="media-body">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="<?=$url?>public/images/profile/6.jpg" alt="image" class="mr-3 rounded"
                                            width="75">
                                        <div class="media-body">
                                            <h5 class="m-b-5">Collection of textile samples</h5>
                                            <p class="mb-0">I shared this on my fb wall a few months back, and I
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="<?=$url?>public/images/profile/7.jpg" alt="image" class="mr-3 rounded"
                                            width="75">
                                        <div class="media-body">
                                            <h5 class="m-b-5">Collection of textile samples</h5>
                                            <p class="mb-0">I shared this on my fb wall a few months back, and I
                                                ...
                                                <div class="my-post-content pt-3">
                                                    <div class="post-input">
                                                        ...
                                                        <a href="javascript:void()"
                                                            class="btn btn-primary light px-3"><i
                                                                class="fa fa-link"></i> </a>
                                                        <a href="javascript:void()"
                                                            class="btn btn-primary light mr-1 px-3"><i
                                                                class="fa fa-camera"></i> </a><a
                                                            href="javascript:void()" class="btn btn-primary">Post</a>
                                                    </div>
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="<?=$url?>public/images/profile/8.jpg" alt=""
                                                            class="img-fluid">
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="<?=$url?>public/images/profile/9.jpg" alt=""
                                                            class="img-fluid">
                                                        <a class="post-title" href="javascript:void()">
                                                            <h4>Collection of textile samples lay spread</h4>
                                                        </a>
