    ...
    <li class="nav-item dropdown notification_dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-right p-3">
              ...
              <a class="timeline-panel text-muted" href="javascript:;">
                ...
                <h6 class="mb-0">Mashable, a news website and blog, goes live.</h6>
                  ...
                  <li class="nav-item dropdown header-profile">
                      <a class="nav-link" href="javascript:;" role="button" data-toggle="dropdown">
                          <img src="<?=$url?>public/images/profile/12.png" width="20" alt=""/>
        <div class="header-info">
          <span>David<i class="fa fa-caret-down ml-3" aria-hidden="true"></i></span>
        </div>
                      </a>
                      <div class="dropdown-menu dropdown-menu-right">
        ...
        ***********************************-->
        ...
        <div class="plus-box">
          <p class="fs-16 font-w500 mb-1">Get summary report now</p>
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Profile</a></li>
                ...
                <div class="row">
                  ...
                  <div class="profile-photo">
                    <img src="<?=$url?>public/images/profile/profile.png" class="img-fluid rounded-circle" alt="">
                  </div>
                    ...
                    <div class="col-xl-4">
                      ...
                      <a href="javascript:void()" class="btn btn-primary mb-1">Send Message</a>
                                ...
                                <div class="profile-blog mb-5">
                                    ...
                                    <img src="<?=$url?>public/images/profile/1.jpg" alt="" class="img-fluid mt-4 mb-4 w-100">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                            <a href="javascript:void()" class="interest-cat">
                                                <img src="<?=$url?>public/images/profile/2.jpg" alt="" class="img-fluid">
                                                <p>Shopping Mall</p>
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                            <a href="javascript:void()" class="interest-cat">
                                                <img src="<?=$url?>public/images/profile/3.jpg" alt="" class="img-fluid">
                                                <p>Photography</p>
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                            <a href="javascript:void()" class="interest-cat">
                                                <img src="<?=$url?>public/images/profile/4.jpg" alt="" class="img-fluid">
                                                <p>Art &amp; Gallery</p>
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                ...
                                <div class="profile-news">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="<?=$url?>public/images/profile/5.jpg" alt="image" class="mr-3 rounded" width="75">
                                        <div class="media-body">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="<?=$url?>public/images/profile/6.jpg" alt="image" class="mr-3 rounded" width="75">
                                        <div class="media-body">
                                            <h5 class="m-b-5">Collection of textile samples</h5>
                                            <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                        </div>
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="<?=$url?>public/images/profile/7.jpg" alt="image" class="mr-3 rounded" width="75">
                                        <div class="media-body">
                                            <h5 class="m-b-5">Collection of textile samples</h5>
                                            <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <a href="javascript:void()" class="btn btn-primary light px-3"><i class="fa fa-link"></i> </a>
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="<?=$url?>public/images/profile/8.jpg" alt="" class="img-fluid">
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="<?=$url?>public/images/profile/9.jpg" alt="" class="img-fluid">
                                                        <a class="post-title" href="javascript:void()">
                                                            <h4>Collection of textile samples lay spread</h4>
                                                        </a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
