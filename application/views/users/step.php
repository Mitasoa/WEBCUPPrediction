            ...
            if (xhr.readyState == 4) {
                if (xhr.status == 200) {
                    ...
                    for ($i = 0; $i < retour.length; $i++) {
                        option = option + '<div class="shadow-sm"style="background:none;"><div class="card" style="background:none;"><div class="card-img">'+
                        '<img src="<?php echo site_url('assets/img/endroit')?>' +"/"+ retour[$i].image + '"style="width:300px;height:300px"/><input style="width:300px;" type="checkbox" name="endroit[]" value=' + retour[$i].id + '></div></div></div>';
                    }
                                    ...
                                    <div class="multisteps-form__di-content">
                                        <div class="form-row mt-4">
                                            <div class="col">
                                                ...
                                                <textarea style="font-size:40px;" class="multisteps-form__input form-control" type="text"
                                        ...
                                        <div class="form-row mt-4">
                                            ...
                                            <div class="col-12 col-sm-6 mt-4 mt-sm-0">
                                                Endroit:
                                                    ...
                                                    <textarea style="font-size:40px;" type="text" id="endroit" onkeyup="find_endroit() "
                                                    onchange="find_endroit_2()"
                                                    placeholder="Action" name="endroit"placeholder="RECHERCE ENDROIT DE REVE"></textarea>
                                                <select class="form-control" style="width:200px;heigth:100px;" name="endroit2" id="_endroit" onchange="find_endroit_2()">
                    ...
                    foreach ($revedescription as $key) {
                        ...
                        <article class="coco-card">
                            ...
                            <div class="coco-card__body">
                                ...
                                <a href="<?= site_url('UsersController/ordonner?id=' . $key['id']); ?>&idreve=<?= $idreve ?>">
