            ...
            <div class="di-content">
                ...
                ?></h2>
                    ...
                    <div class="o-card">
                        ...
                        <form action="<?= site_url('UsersController/insertreve') ?>" class="form" method="POST">
                            <input class="input-group" type="date" name="date">
                            <input type="hidden" name="idreve" value="<?=$idreve?>" />
                            <input class="input-group" type="submit" class="btn btn-primary">
