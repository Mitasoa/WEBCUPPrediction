        ...
        <div class="di-media-timeline-left">
          ...
          <div class="di-media-event box">
            <div class="di-media-event-wrapper">
              <img src="https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80" class="di-media-event-img" />
        ...
        <div class="di-media-timeline-right">
          <div class="di-media-status box">
            ...
            <div class="di-media-status-main">
              <img src="https://images.genius.com/2326b69829d58232a2521f09333da1b3.1000x1000x1.jpg" class="di-media-status-img">
              <textarea class="di-media-status-textarea" placeholder="Write something to Quan Ha.."></textarea>
            </div>
          ...
          <div class="di-media-album box">
            <div class="di-media-status-main">
              ...
              <div class="di-media-album-detail">
                <div class="di-media-album-title"><strong>Quan Ha</strong> create new <span>album</span></div>
            ...
            <div class="di-media-album-content">When the bass drops, so do my problems.
              <div class="di-media-album-photos">
                <img src="https://images.unsplash.com/photo-1508179719682-dbc62681c355?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2378&q=80" alt="" class="di-media-album-photo" />
                <div class="di-media-album-right">
                  <img src="https://images.unsplash.com/photo-1502872364588-894d7d6ddfab?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2250&q=80" alt="" class="di-media-album-photo" />
                  <img src="https://images.unsplash.com/photo-1566737236500-c8ac43014a67?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80" alt="" class="di-media-album-photo" />
                </div>
              </div>
            </div>
            <div class="di-media-album-actions">
              ...
              <a href="#" class="di-media-album-action">
                <svg stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="di-media-css-i6dzq1" viewBox="0 0 24 24">
