...
ALTER TABLE
	revedescriptionimage
ADD
	FOREIGN KEY(idimageendroit) REFERENCES imageendroit(id);
...
CREATE VIEW listepredictionreve as
select
	predictionreve.*,
	prediction.photo,
...
from
	predictionreve
	join prediction on prediction.id = predictionreve.idprediction;
